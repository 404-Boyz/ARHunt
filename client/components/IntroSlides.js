...
export default class IntroSlides extends Component {
    ...
    constructor(props) {
        super(props)
        this.state = {
            cards: [{ title: 'START ADVENTURE', text: 'Head to the adventures screen and tap one to begin your journey. The first clue box will appear in front of you. Tap it for your first clue.', image: require('../assets/img/icon_1.png') }, { title: 'FOLLOW MAP', text: 'Use the shaded circle on your map to find your next clue box. Once you are close enough the camera will open for you.', image: require('../assets/img/icon_2.png') }, { title: 'FIND CLUES', text: 'Use the camera view to find hidden augmented reality clue boxes. They\'re the ones with the question marks on them.', image: require('../assets/img/icon_3.png') }, { title: 'GET HINTS', text: 'Feeling stuck? Tap the question mark icon on the clue or in your clue list to receive some additional hints.', image: require('../assets/img/icon_4.png') }, { title: 'HAVE FUN', text: 'Make sure to have a great time and always be aware of your surroundings! Love, the 404 Boiz', image: require('../assets/img/icon_5.png') }],
            activeSlide: 0
        }
    }
